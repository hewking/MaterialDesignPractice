      ...
      <div class="add-cat">
          <form class="form-horizontal">
              <div class="control-group">
                  <label class="control-label" for="inputEmail">父类</label>
                  <div class="controls">
                      <select id="fid" name="fid" >
                          <option value="0">顶级</option>
                          <?php if(is_array($tree)): foreach($tree as $key=>$tree): if($tree["cat_id"] == $Catalog["cat_id"] ): else: ?>
                              <option <?php if($tree["cat_id"] == $Catalog["pid"] ): ?>selected="true"<?php endif; ?> value="<?php echo ($tree["cat_id"]); ?>" ><?php echo ($tree["cat_name"]); ?></option><?php endif; endforeach; endif; ?>
                      </select>
                  </div>
              </div>
