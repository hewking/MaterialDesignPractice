package com.dlodlo.widget.linkpreview;
...
//            urls = (ArrayList<String>) Arrays.asList(params[0]);
//            if (urls.size() > 0)
//                sourceContent.setFinalUrl(unshortenUrl(extendedTrim(params[0])));
            sourceContent.setFinalUrl(params[0]);
//            else {
